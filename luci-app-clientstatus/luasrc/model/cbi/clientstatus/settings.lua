...
m = Map("clientstatus", translate("Client Management Settings"),
	translate("Configure the LAN client status monitor. Changes take effect after saving and restarting the service.<br />") ..
...
o = s:option(Value, "interval", translate("Refresh Interval (seconds)"),
	translate("How often to scan and ping all clients. Default: 30 seconds."))
o.default = "30"
